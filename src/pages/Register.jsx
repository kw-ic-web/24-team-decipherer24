...
const Register = () => {
    ...
    const checkID = async () => {
        try {
            const response = await axios.get('https://team06-api.kwweb.duckdns.org/api/check-id', {
    ...
    const handleRegister = async (e) => {
        ...
        try {
            const response = await axios.post('https://team06-api.kwweb.duckdns.org/api/register', {
                id: user.id,
